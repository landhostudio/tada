  ...
  if (!function_exists('tada_setup')) {
    ...
    function tada_setup() {
      ...
      function init_assets() {
        ...
        wp_enqueue_style('all-css', get_template_directory_uri() . '/dist/css/all.css', array(), '1.3', 'all');

        wp_register_script('all-js', get_template_directory_uri() . '/dist/js/all.js', array(), '1.3', 'all');
